package com.myOtherStream.itheima_04;
...
public class PropertiesTest {
    public static void main(String[] args) throws IOException {
        ...
        FileReader fr = new FileReader("day10\\src\\com\\myOtherStream\\game.txt");
        prop.load(fr);
        fr.close();
        ...
        if(number >= 3) {
            ...
            FileWriter fw = new FileWriter("day10\\src\\com\\myOtherStream\\game.txt");
            prop.store(fw,null);
            fw.close();
        }
    }
